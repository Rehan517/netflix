...
import { HandThumbUpIcon, PlusIcon, SpeakerWaveIcon, SpeakerXMarkIcon, XCircleIcon, XMarkIcon } from '@heroicons/react/20/solid'
...
export default function Modal() {
    ...
    useEffect(() =>{
        ...
        //Fix up API Key later
        async function fetchMovie(){
            const data = await fetch(`https://api.themoviedb.org/3/${
                movie?.media_type === 'tv' ? 'tv' : 'movie'
              }/${movie?.id}?api_key=4b68f0c2db5b32a9cf750319c4a1a5e5&language=en-US&append_to_response=videos`)
