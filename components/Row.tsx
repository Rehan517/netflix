...
export default function Row({title, movies}:Props) {
    ...
    //custom fuction which allows user to browse movies left and right
  ...
  return (
    ...
    <div ref={rowRef} className='flex items-centre space-x-0.5 overflow-x-scroll scrollbar-hide md:space-x-2.5
    md:p-2'>
        {movies.map((movie)=>(
